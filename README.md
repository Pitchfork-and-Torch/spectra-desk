...
<p align="center">
  <img src="docs/assets/spectra-v9-infographic.png" alt="Spectra Desk v9.0.0 Corroborate - claim ledger, corroboration matrix, human LOCK, 898 operator tools, free Windows app" width="100%" />
</p>
...
The standalone exe and the portable zip stay free. No license key. No account. A paid Telegram room is a separate operated service (`docs/v10/CHANNEL.md`). It does not gate this download.
